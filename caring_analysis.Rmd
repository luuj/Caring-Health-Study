...
```{r}
# Find out people with >=4 screens - get IDs
View(screen.count %>% filter(n>=4) %>% rename("n_screens" = "n")) 

# TODO - can reduce certain questions down to one to prevent recounting
# In-progress - finding out what the inclusion criteria are to define what missingness is
# Next steps: Conceptualizing the range of missingness in SDH data
# How close are you to meeting implementation requirements
```
